...
//The problem doesn't happen in the new code, because code rejects the promise with an error when the die rolls off the table and this is produced by the .catch() method.
