...
-----------------------------------------------------------------------------*/
function giveCompliment(somebodyName) {
  const compliments=['great','cool','awesome','nice','shiny','sweet','pretty','smart','elegant','kind']
  return `You are ${compliments[Math.floor(Math.random()*compliments.length)]}, ${somebodyName}!`;
